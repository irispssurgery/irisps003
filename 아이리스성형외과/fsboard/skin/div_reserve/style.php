...
/* 리스트 - 레이아웃 스타일 */
	...
	div.ListBody { clear:both; height:1.3em; padding:0.7em; border-bottom:1px solid #e1e1e1; }
		...
		.ListBody4 { float:left; width:<?=($useCategory?47:54)?>%; text-align:left; white-space:normal; }
		...
		.ListBody7 { float:right; width:6%; text-align:center; } p.ListBody7 { font-family:Verdana; font-size:1em; }
		.ListBody8 { float:right; width:6%; text-align:center; } p.ListBody8 { font-family:Verdana; font-size:1em; }
