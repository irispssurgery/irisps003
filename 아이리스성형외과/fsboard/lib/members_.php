...
<div id="member_join_layout">
	<div id="stipulation">
		<h4>- 회원 가입 안내 -</h4>
			<h5>1. 사이트 소개</h5>
				<ul>인터넷을 즐기는 모든 분들이 자유롭게 어울리고 좋은 자료들을 공유할수 있는 사이트입니다.</ul>
			<h5>2. 회원 가입</h5>
				<ul>회원가입을 하지 않아도 모든 게시판을 열람하거나, 자료를 다운로드 받을 수 있습니다.</ul>
				<ul>다만 사이트의 안정적인 운영을 위하여 글을 쓰거나 일부 기능은 회원가입 후 사용하실 수 있습니다.</ul>
			<h5>3. 회원가입시 입력사항</h5>
				<ul>회원가입시 입력하는 개인정보는 공개하지 않는 한 절대 운영자가 다른 목적으로 이용하지 않습니다.</ul>
				<ul>개인정보는 운영의 편의성을 제공하기 위해서 입력받고 있습니다.</ul>
			<h5>4. 회원가입 및 이용시 유의사항</h5>
				<ul>- 아래와 같은 경우는 경고 없이 아이디가 차단될 수 있으니 유의해 주시기 바랍니다.</ul>
				<ul>&nbsp; * 비방, 욕설, 인신공격 등을 하였을 경우</ul>
				<ul>&nbsp; * 특정인이나 다수에 대한 불쾌한 행위나 비매너적인 행위를 일삼을 경우</ul>
				<ul>&nbsp; * 같은 내용의 글을 여러게시판에 도배를 할경우 (내용에 상관없음)</ul>
				<ul>- 게시판에 작성된 글 중 해당 게시판의 내용에 적절하지 못한 게시물일 경우 관리자가 판단하여 적절한 게시판으로 게시물이 이동될수 있습니다.</ul>
				<ul>- 불법 자료를 자료실등에 등록하는 경우는 무조건 회원 권한이 박탈되며, 경우에 따라서 경찰이나 저작권자에게 개인정보가 제공될수 있습니다.</ul>
			<h5>5. 회원 탈퇴</h5>
				<ul>- 회원 탈퇴는 언제든 가능하며, 탈퇴 즉시 탈퇴회원의 모든 데이터는 완전히 삭제되며 복구할 수도 없게됩니다.</ul>
				<ul>- 탈퇴는 개인정보 변경 메뉴에서 하실 수 있습니다.</ul>
			<h5>6. 가입 방법</h5>
				<ul>- 아래 항목들의 내용을 입력한 후 확인 버튼을 클릭하면 가입이 완료되며 로그인 상태가 됩니다.</ul>
				<ul>- 이메일 주소는 가입, 탈퇴, 암호분실시에 사용되므로 반드시 사용하는 메일을 정확하게 입력해 주세요.</ul>
	</div>
...
-->
		<div class="member_join_cr">
			<div class="member_join_mleft">자기소개</div>
			<div class="member_join_mright">
				<textarea id="mem_intro" name="mem_intro" cols="65" rows="4" class="txtbox2"></textarea><br />
				<input type="checkbox" id="public_intro" name="public_intro" value="1" checked="checked" />자기소개 공개
				<input type="checkbox" id="public_regdate" name="public_regdate" value="1" />가입일자 공개
				<input type="checkbox" id="public_latestdate" name="public_latestdate" value="1" />마지막로그인일자 공개
			</div>
		</div>
		<div class="member_join_cr">
...
//////////////////////////////////////////////////////////////////////////////////////////ADMIN.회원정보 수정
	...
	echo "
		...
		<tr>
			<td>&nbsp; 회원등급</td>
			<td><input type=\"text\" id=\"mem_grade\" name=\"mem_grade\" class=\"txtbox\" value=\"{$mem_grade}\" size=\"20\" /></td>
		</tr>
		<tr>
			<td>&nbsp; <b>이름*</b></td>
			<td>
		...
		<tr>
			<td>&nbsp; 닉네임</td>
			<td><input type=\"text\" id=\"mem_nickname\" name=\"mem_nickname\" class=\"txtbox\" value=\"{$mem_nickname}\" />(이름 대신 사용할 별명)</td>
		</tr>
		<tr>
			<td>&nbsp; 이메일</td>
			<td>
		...
		<tr>
			<td>&nbsp; 홈페이지</td>
			<td>
				<input type=\"text\" id=\"mem_homepage\" name=\"mem_homepage\" class=\"txtbox\" value=\"{$mem_homepage}\" size=\"50\" />
				<input type=\"checkbox\" id=\"public_homepage\" name=\"public_homepage\" value=\"1\"".($public_homepage?" checked=\"checked\"":"")." />공개
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>&nbsp; 직업</td>
			<td>
				<input type=\"text\" id=\"mem_job\" name=\"mem_job\" class=\"txtbox\" value=\"{$mem_job}\" size=\"25\" />
				<input type=\"checkbox\" id=\"public_job\" name=\"public_job\" value=\"1\"".($public_job?" checked=\"checked\"":"")." />공개
			</td>
		</tr>
		<tr>
			<td>&nbsp; 취미</td>
			<td>
				<input type=\"text\" id=\"mem_hobby\" name=\"mem_hobby\" class=\"txtbox\" value=\"{$mem_hobby}\" size=\"25\" />
				<input type=\"checkbox\" id=\"public_hobby\" name=\"public_hobby\" value=\"1\"".($public_hobby?" checked=\"checked\"":"")." />공개
			</td>
		</tr>
		<tr>
			<td>&nbsp; 생년월일</td>
			<td>
				<input type=\"text\" id=\"mem_birthday\" name=\"mem_birthday\" class=\"txtbox\" value=\"{$mem_birthday}\" size=\"25\" />(".date("Y-m-d").")
				<input type=\"checkbox\" id=\"public_birthday\" name=\"public_birthday\" value=\"1\"".($public_birthday?" checked=\"checked\"":"")." />공개
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>&nbsp; 사진</td>
			<td>
				<input type=\"file\" id=\"attachFile1\" name=\"attachFile1\" class=\"txtbox\" size=\"30\" />
				<input type=\"checkbox\" id=\"public_picture\" name=\"public_picture\" value=\"1\"".($public_picture?" checked=\"checked\"":"")." />공개<br />가로/세로 크기 200px 내외, JPG,GIF,BMP,PNG파일
				";if($mem_picture) { echo "<br /><img src=\"{$FSBOARD_PATH}/data/{$dataPath}/{$mem_picture}\" id=\"mem_img1\" onload=\"controlImage(this.id,150);\" onclick=\"vwimgrzmv(this,this.src);\" alt=\"회원사진\" style=\"border:1px solid #E0E0E0\" /> {$mem_picture} <input type=\"checkbox\" id=\"delAttachFile1\" name=\"delAttachFile1\" value=\"1\" />삭제"; } echo "
			</td>
		</tr>
		<tr>
			<td>&nbsp; 이름마크 이미지</td>
			<td>
				<input type=\"file\" id=\"attachFile2\" name=\"attachFile2\" class=\"txtbox\" size=\"30\" />(이름앞에 붙는 이미지)<br />가로/세로 크기 18px 이내, GIF만 가능
				";if($mem_imgmark) { echo "<br /><img src=\"{$FSBOARD_PATH}/data/{$dataPath}/{$mem_imgmark}\" id=\"mem_img2\" onload=\"controlImage(this.id,50);\" onclick=\"vwimgrzmv(this,this.src);\" alt=\"회원마크\" style=\"border:1px solid #E0E0E0\" /> {$mem_imgmark} <input type=\"checkbox\" id=\"delAttachFile2\" name=\"delAttachFile2\" value=\"1\" />삭제"; } echo "
			</td>
		</tr>
		<tr>
			<td>&nbsp; 이름 이미지</td>
			<td>
				<input type=\"file\" id=\"attachFile3\" name=\"attachFile3\" class=\"txtbox\" size=\"30\" />(이름대신 사용할 이미지)<br />세로 크기 18px 이내, GIF만 가능
				";if($mem_imgname) { echo "<br /><img src=\"{$FSBOARD_PATH}/data/{$dataPath}/{$mem_imgname}\" id=\"mem_img3\" onload=\"controlImage(this.id,100);\" onclick=\"vwimgrzmv(this,this.src);\" alt=\"회원이름\" style=\"border:1px solid #E0E0E0\" /> {$mem_imgname} <input type=\"checkbox\" id=\"delAttachFile3\" name=\"delAttachFile3\" value=\"1\" />삭제"; } echo "
			</td>
		</tr>
		<tr>
			<td>&nbsp; 자기소개</td>
			<td>
				<textarea id=\"mem_intro\" name=\"mem_intro\" rows=\"3\" cols=\"60\" class=\"txtbox2\">$mem_intro</textarea><br />
				<input type=\"checkbox\" id=\"public_intro\" name=\"public_intro\" value=\"1\"".($public_intro?" checked=\"checked\"":"")." />공개
			</td>
		</tr>
		<tr>
			<td>&nbsp; <b>가입정보</b></td>
			<td>
				<table width=\"100%\" cellpadding=\"3\" cellspacing=\"0\" border=\"1\" bordercolor=\"#E0E0E0\" style=\"border-collapse:collapse;\" class=\"defstyle\">
					<tr>
						<td>가입</td>
						<td>".date("Y-m-d (H:i:s)",$mem_regdate)." <input type=\"checkbox\" id=\"public_regdate\" name=\"public_regdate\" value=\"1\"".($public_regdate?" checked=\"checked\"":"")." />공개</td>
						<td>$mem_ip_reg</td>
					</tr>
					<tr>
						<td>정보수정</td>
						<td>".($mem_editdate?date("Y-m-d (H:i:s)",$mem_editdate):"")."</td>
						<td>$mem_ip_edit</td>
					</tr>
					<tr>
						<td>마지막로그인</td>
						<td>".($mem_latestdate?date("Y-m-d (H:i:s)",$mem_latestdate):"")." <input type=\"checkbox\" id=\"public_latestdate\" name=\"public_latestdate\" value=\"1\"".($public_latestdate?" checked=\"checked\"":"")." />공개</td>
						<td>$mem_ip_login</td>
					</tr>
					<tr>
						<td>총 로그인 횟수</td>
						<td>$mem_loginnum 회</td>
						<td></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td> &nbsp; 정보공개</td>
			<td><input type=\"checkbox\" id=\"public_all\" name=\"public_all\" value=\"1\"".($public_all?" checked=\"checked\"":"")." />회원정보 공개</td>
		</tr>
	</table>
