...
if(!$MODE || $MODE == "") { //////////////////////////////////////////////////////////////////////도움말
	...
	if(!$checkAdminTable) {
		...
		$query = "
			CREATE TABLE `{$_table_id_admin}` (
				...
				`useOther01` tinyint(1) default NULL,
				`useOther02` tinyint(1) default NULL,
				`useOther03` tinyint(1) default NULL,
				`useOther04` tinyint(1) default NULL,
				`useOther05` tinyint(1) default NULL,
				`useOther06` tinyint(1) default NULL,
				`useOther07` tinyint(1) default NULL,
				`useOther08` tinyint(1) default NULL,
				`useOther09` tinyint(1) default NULL,
				`useOther10` tinyint(1) default NULL,
	...
	$useOther01				= 0; //기타 필드 사용
	$useOther02				= 0; //기타 필드 사용
	$useOther03				= 0; //기타 필드 사용
	$useOther04				= 0; //기타 필드 사용
	$useOther05				= 0; //기타 필드 사용
	$useOther06				= 0; //기타 필드 사용
	$useOther07				= 0; //기타 필드 사용
	$useOther08				= 0; //기타 필드 사용
	$useOther09				= 0; //기타 필드 사용
	$useOther10				= 0; //기타 필드 사용
	...
	if($result) {
		...
		if($numrows) {
			...
			<tr align=\"center\" onmouseover=\"this.bgColor='#FAFAFA';\" onmouseout=\"this.bgColor='';\">
				...
				<!--<td>
					<a href=\"/{$FSBOARD_PATH}/{$_fsMainExecFile}?id={$boardId}&mode=admin\" onclick=\"window.open(this.href,'_blank'); return false;\"><img src=\"/{$FSBOARD_PATH}/img/clip/admin.gif\" alt=\"관리\" /></a>
				</td>-->
				<td>
					<a href=\"/wb_admin/intro/board/list.htm?id={$boardId}&mode=admin\" onclick=\"window.open(this.href,'_parent'); return false;\"><img src=\"/{$FSBOARD_PATH}/img/clip/admin.gif\" alt=\"관리\" /></a>
				</td>
				<td>
		...
		<table width=\"{$width}\" align=\"{$align}\" class=\"defstyle\">
			...
			<tr>
				<td align=\"center\">
					...
					</select> <input type=\"text\" size=\"20\" name=\"srhstr\" class=\"txtbox1\" /> <input type=\"image\" src=\"/$FSBOARD_PATH/img/btn/search.gif\" align=\"middle\" />
