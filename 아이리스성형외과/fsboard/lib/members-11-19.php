...
-->
		...
		<div class="member_join_cr">
			<div class="member_join_mleft"><b>소 속*</b></div>
			<div class="member_join_mright">
				<select id="mem_part2" name="mem_part2">
					<option value="">--선택--</option>
<?
	for($i=0;$i < sizeof($mem_part_element2); $i++) {
		echo "					<option>".$mem_part_element2[$i]."</option>\n";
	}
?>
				</select>
				해당 되는 소속분류를 선택
		...
		<div class="member_join_cr">
			<div class="member_join_mleft"><b>입사년차*</b></div>
			<div class="member_join_mright">
				<select id="mem_part3" name="mem_part3">
					<option value="">--선택--</option>
<?
	for($i=0;$i < sizeof($mem_part_element3); $i++) {
		echo "					<option>".$mem_part_element3[$i]."</option>\n";
	}
?>
				</select>
				해당 되는 입사년차를 선택
...
//////////////////////////////////////////////////////////////////////////////////////////회원가입처리
	...
	$mem_part2			= StrAddSlashes(trim($_POST["mem_part2"]));
	$mem_part3			= StrAddSlashes(trim($_POST["mem_part3"]));
...
//////////////////////////////////////////////////////////////////////////////////////////회원정보수정
	...
	if($result) {
		...
		if(!$numrows) Error("회원정보가 없거나 세션시간이 만료되었습니다.");
			...
			$mem_part2			= $rs["mem_part2"];
			$mem_part3			= $rs["mem_part3"];
...
-->
		...
		<div class="member_modify_cr">
			<div class="member_modify_mleft"><b>소 속*</b></div>
			<div class="member_modify_mright">
<?

	echo "
				<select id=\"mem_part2\" name=\"mem_part2\"".($mem_level==1?" disabled":"").">
					<option value=\"\">--선택--</option>
	";
	for($i=0;$i < sizeof($mem_part_element2); $i++) {
		echo "			<option".($mem_part2==$mem_part_element2[$i]?" selected=\"selected\"":"").">".$mem_part_element2[$i]."</option>\n";
	}
	echo "
				</select>
	";
?>
		...
		<div class="member_modify_cr">
			<div class="member_modify_mleft"><b>입사년차*</b></div>
			<div class="member_modify_mright">
<?

	echo "
				<select id=\"mem_part3\" name=\"mem_part3\"".($mem_level==1?" disabled":"").">
					<option value=\"\">--선택--</option>
	";
	for($i=0;$i < sizeof($mem_part_element3); $i++) {
		echo "			<option".($mem_part3==$mem_part_element3[$i]?" selected=\"selected\"":"").">".$mem_part_element3[$i]."</option>\n";
	}
	echo "
				</select>
	";
...
//////////////////////////////////////////////////////////////////////////////////////////ADMIN.회원정보 수정
	...
	echo "
		...
		<tr>
			<td>&nbsp; <b>소 속*</b></td>
			<td>
				<select id=\"mem_part2\" name=\"mem_part2\"".($mem_id==$MemId?" disabled":"").">
	";
	for($i=0;$i < sizeof($mem_part_element2); $i++) {
		echo "		<option".($mem_part2==$mem_part_element2[$i]?" selected=\"selected\"":"").">".$mem_part_element2[$i]."</option>";
	}
	echo "
		...
		<tr>
			<td>&nbsp; <b>입사년차*</b></td>
			<td>
				<select id=\"mem_part3\" name=\"mem_part3\"".($mem_id==$MemId?" disabled":"")." >
	";
	for($i=0;$i < sizeof($mem_part_element3); $i++) {
		echo "		<option".($mem_part3==$mem_part_element3[$i]?" selected=\"selected\"":"").">".$mem_part_element3[$i]."</option>";
	}
